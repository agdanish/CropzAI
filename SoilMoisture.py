"""
Agent 18: SoilMoisture
Analyzes soil moisture levels against crop-specific requirements using Ollama LLM and SQLite.
"""
...
class SoilMoisture:
    ...
    def analyze(self, input_data, session_id=None):
        ...
        prompt = f"""
        The current soil moisture in {region} is {moisture}%. Crop selected: {crop}.
        Rainfall received: {rainfall} mm.

        Is the soil moisture optimal for this crop? Recommend irrigation or moisture retention strategies.
        """
