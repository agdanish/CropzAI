...
Analyzes temperature conditions for potential risks to crop health using Ollama LLM and SQLite.
"""
...
class Temperature:
    ...
    def analyze(self, input_data, session_id=None):
        ...
        prompt = f"""
        Evaluate the current temperature of {temp}°C in {region} for the crop {crop}.
